	...
	<main>
	    ...
	    <header style="display:flex; justify-content:space-between">
			<form method="post" action="deleteTeam">
				<input type="text" name="name" placeholder="input Team name"/>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
												<form method="post" action="/showTeams">
													<input type="text" name="teamId" value="<c:out value="${team.teamId}"/>" style="display:none;"/>
													<input type="submit" value="<c:out value="${team.name}"/>" style="text-align:left; width:100%; border:none; background-color:white;"/>
                                                </form>
                                               </div>
                                        </div>
                                	<form method="post" action="/deleteTeam" >
                                        <div class="col-auto">
											<input type="text" name="name" value='<c:out value="${team.name}"/>' style='display:none;'/>
