...
<head>
    ...
    <title>Creation d'une �quipe</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            ...
                                            <form class="user" action="/addTeam" method="POST">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" id="teamName"
                                                        placeholder="Nom de l'equipe " name="name">
                                                </div>
                                                <!-- <div class="form-group">
                                                ...
                                                <div class="btn-block">
                                                    <a href="/showTeams" class="btn btn-secondary btn-user ">
                                                        Afficher Teams
                                                    </a>
